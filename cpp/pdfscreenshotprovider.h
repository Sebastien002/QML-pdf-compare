...
public slots:
     ...
     * @param text
     */
    void selectedText(const QString &path,int pageNum,const QPoint &startPos,const QPoint &endPos, const QString &color);
    void addPencil(const QString &path, int pageNum, const QPoint &startPos, const QVariantList& lists/*, const QString &color*/);
...
private:
    ...
    void writePageChangeToPainter(QPainter *painter,FileProperties *fp,int pageNum,bool ignoreZoomRatio = false, const QString &path = "");
...
private:
    ...
    QList<qint64> searchedTextItems;

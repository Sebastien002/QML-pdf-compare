#ifndef PdfScreenshotProvider1_H
#define PdfScreenshotProvider1_H
...
//提供PDF快照
class PdfScreenshotProvider1: public QObject , public QQuickImageProvider
{
    Q_OBJECT
public:
    explicit PdfScreenshotProvider1(QObject *parent = nullptr);
    ...
    struct ChangeItem {  //修改具体位置
        ...
        ChangeType type;
        QPoint pos;
        QList<QRectF> rects;//For selection text
        int pageNum = -1;
        QVariant change;
        QString color;
    };
...
public slots:
     ...
     * @param text
     */
    void selectedText(const QString &path,int pageNum,const QPoint &startPos,const QPoint &endPos);
...
public:
    void searchText(const QString& text, const QString& path, const QString &color);
...
private:
    ...
    //QMap<int, QList<QRectF>> _cacheSearchRect;
    QString m_strSearchText;
    QString m_strPath;
    QString m_strColor;
};

#endif // PdfScreenshotProvider1_H
